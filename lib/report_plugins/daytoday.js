...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  function drawChart (day, data, options) {
    ...
    data.treatments.forEach(function(treatment) {
      ...
      // Niki ----------------------------------------------------------------------
      if (treatment.eventType === 'BG Check') return;       // dont show event BG Check (BG-Prüfung)
      if (treatment.eventType === 'Announcement') return;   // dont show event Announcement (Ankündigung)
      // Niki ----------------------------------------------------------------------
